...
const GITHUB_URL = 'https://github.com/KunalGhadge/velxioAI';
        ...
        <div className="header-left">
          ...
          <div className="header-brand">
            ...
            <Link to={localize('/')} style={{ textDecoration: 'none', color: 'inherit' }}>
              <span className="header-title" style={{ fontWeight: 700, letterSpacing: -0.5 }}>
                Velxio<span style={{ color: '#0071e3' }}>AI</span>
              </span>
            </Link>
          </div>
