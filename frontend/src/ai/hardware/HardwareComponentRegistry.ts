...
export const HARDWARE_COMPONENT_PROFILES: Record<string, HardwareComponentProfile> = {
  ...
  'wokwi-mpu6050': {
    ...
    pins: [
      { name: 'VCC', signalType: 'power_vcc', description: 'Power (+3.3V or 5V)' },
      { name: 'GND', signalType: 'power_gnd', description: 'Ground' },
      { name: 'SCL', signalType: 'i2c_scl', description: 'I2C Clock' },
      { name: 'SDA', signalType: 'i2c_sda', description: 'I2C Data' },
    ],
    powerPins: { vcc: 'VCC', gnd: 'GND' },
  },
  'wokwi-bmp280': {
    id: 'wokwi-bmp280',
    tagName: 'wokwi-bmp280',
    ...
    recommendedVoltage: 3.3,
    pins: [
      { name: 'VCC', signalType: 'power_vcc', description: 'Power (+3.3V)' },
      { name: 'GND', signalType: 'power_gnd', description: 'Ground' },
      { name: 'SCL', signalType: 'i2c_scl', description: 'I2C Clock' },
      { name: 'SDA', signalType: 'i2c_sda', description: 'I2C Data' },
    ],
  ...
  'wokwi-pcf8574': {
    id: 'wokwi-pcf8574',
    tagName: 'wokwi-pcf8574',
    name: 'PCF8574 I2C 8-bit I/O Expander / LCD Backpack',
    category: 'displays',
    busType: 'i2c',
    i2cDefaultAddress: 0x27,
    recommendedVoltage: 5.0,
    pins: [
      { name: 'VCC', signalType: 'power_vcc', description: 'Power (+5V)' },
      { name: 'GND', signalType: 'power_gnd', description: 'Ground' },
